...
ds = xr.open_dataset(r"/Users/Jia/Downloads/data_skripsi/SO_2/so2.nc") # membuka file nc
ds
...
#mengonversi menjadi mikrogram/meter kubik
df ["so2"] = ((df["so2"]/0.000000001)*6.62)
df.to_csv("/Users/Jia/Downloads/data_skripsi/SO_2/so2_arrange.csv")