...
ds = xr.open_dataset(r"/Users/Jia/Downloads/data_skripsi/PM_25/pm25.nc") # membuka file nc
ds
...
#mengonversi kg/meter kubik menjadi mikrogram/meter kubik
df ["pm2p5"] = df["pm2p5"] * 1000000000 #di kali
df.to_csv("pm25_arrange.csv")